...
function SignUpForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:4000/nurse-personal-details', formData);
    ...
    <div className='container-fluid'>
      <div className='card'>
        <div className='card-body px-4'>
          <h3 className="fw-bold mb-4 pb-2 pb-md-0 mb-md-5">Nurse Registration Form</h3>

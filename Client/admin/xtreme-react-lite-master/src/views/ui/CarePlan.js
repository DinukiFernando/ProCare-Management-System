...
import { Button, Card, CardBody, CardTitle, CardSubtitle, Table, Modal, ModalHeader, ModalBody, ModalFooter, Form } from "reactstrap";
...
const CarePlan = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    // Add the submitted care plan data to the backend or perform any necessary actions
    setShowModal(false);
  };
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        <Button className="btn" color="primary" size="lg" onClick={handleAddCarePlan}>
          Add a Care Plan
        </Button>
      </div>
      <Card>
...
<Modal isOpen={showModal} toggle={handleModalClose}>
  <ModalHeader toggle={handleModalClose}>Add a Care Plan</ModalHeader>
    ...
    <ModalBody>
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => handleNewTaskChange(e, "patientId")}
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => handleNewTaskChange(e, "firstName")}
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => handleNewTaskChange(e, "lastName")}
        />
      </div>
